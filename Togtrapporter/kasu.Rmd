...
p_load(sqldf,RODBC,plyr,xtable,ggplot2,lubridate,reshape2,ggrepel,grid,gridExtra,
       gplots,Hmisc,stringr,dismo,raster,marmap,rgdal,maptools,rasterVis,shapefiles,
       calibrate,plotrix,base,mapplots,data.table,tinytex,knitr)
...
coastString <- '../discardtjek/kort/europe_simple_wgs84'
...
n.rgroup<-data.frame(table(participants$Leg))

colnames(n.rgroup) <- c("rgroup","n.rgroup")
