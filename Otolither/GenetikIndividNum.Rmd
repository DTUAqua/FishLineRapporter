...
for (st in sort(unique(data_out$station))){
  ...
  cat(sprintf("\\textbf{Art:} %s  & \\textbf{Journal:} %s & \\textbf{Område:} %s & 
    \\textbf{Square:} %s & \\textbf{Havn:} %s \\\\ \n", 
