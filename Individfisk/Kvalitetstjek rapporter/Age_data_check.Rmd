...
y2 <- 2022
species <- c("TOR")
areas <- c(22, 23, 24, 25, 26)
cruise <- c("BITS-1", "IN-LYNG", "KASU-1", "MON")
```
...
if (nrow(age_fish) != 0){
  fun <- function(k) {
    ...
    fun <- function(kk) {
      ...
      plot(new$length_mm, new$weight, pch = 16, cex = 1, col = "red", 
