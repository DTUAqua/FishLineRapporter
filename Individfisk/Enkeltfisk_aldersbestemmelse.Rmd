...
ind_fish_red <- ind_fish[,c("cruise","Maaned","dfuArea","statisticalRectangle","station","speciesCode",
...
names(ind_fish_red) <- c("Togt","Dato","Omr.","Sq.","Stat.","Art","Sort.","Fisk nr.","mm","kg UR","sex","modenh.")
