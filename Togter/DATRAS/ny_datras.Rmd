...
p_load(data.table, lubridate, plyr, suncalc, ggplot2, sm, ggrepel, dbscan, utils)
...
y1 <- 2024
y2 <- 2024
cruise <- c("BV LF BMS mar", "BV LF OES OST mar")
species <- c("BMS")
...
if (exists("toupload")){
  ...
  for (dum in unique(hh$dummy)) {
    ...
    write.table(HH[which(hh$dummy == dum), ], 
                paste0("Q:/mynd/DATRAS/BITS_upload/to_upload/", nam2, ".csv"), 
                row.names = F, quote = F, sep = ",")
  ...
  ##individual files
  write.table(HH, paste0("Q:/mynd/DATRAS/BITS_upload/outputs/HH_", nam, ".csv"), 
              row.names = F, quote = F, sep = ",")
  write.table(HL, paste0("Q:/mynd/DATRAS/BITS_upload/outputs/HL_", nam, ".csv"), 
              row.names = F, quote = F, sep = ",", append = F)
  write.table(CA, paste0("Q:/mynd/DATRAS/BITS_upload/outputs/CA_", nam, ".csv"), 
              row.names = F, quote = F, sep = ",", append = F)
  
  #zip with unefied headder for the datras pakage
  ##unified header format
  write.table(HH, paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".csv"),
              row.names = F, quote = F, sep = ",")
  write.table(HL, paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".csv"),
              row.names = F, quote = F, sep = ",", append = T)
  write.table(CA, paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".csv"),
              row.names = F, quote = F, sep = ",", append = T)
  
  zip(paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".zip"), extras = '-j',
      files = paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".csv"))
  
  if (file.exists(paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".csv"))) {
    #Delete file if it exists
    file.remove(paste0("Q:/mynd/DATRAS/BITS_upload/zips/DATRAS_", nam, ".csv"))
  }
