...
ca[ca$maturityIndexMethod == 'N' & ca$maturityIndex == 21, "Maturity"] <- 2
ca[ca$maturityIndexMethod == 'N' & ca$maturityIndex == 22, "Maturity"] <- 2
ca[ca$maturityIndexMethod == 'N' & ca$maturityIndex == 31, "Maturity"] <- 3
ca[ca$maturityIndexMethod == 'N' & ca$maturityIndex == 32, "Maturity"] <- 3
ca[ca$maturityIndexMethod == 'N' & ca$maturityIndex == 41, "Maturity"] <- 4
ca[ca$maturityIndexMethod == 'N' & ca$maturityIndex == 42, "Maturity"] <- 4
