...
age_fish[ , coments_col] <- lapply(age_fish[ , coments_col], gsub, pattern = "\\.|,|;", replacement = " ")
...
if (nrow(age_fish) != 0){
  ...
  weight_outliers <- outliers[outliers$type == "weight", 
                             c("sdEventId", "speciesCode", "animalId", "sdAnnotationId", "cruise", "catchDate",
