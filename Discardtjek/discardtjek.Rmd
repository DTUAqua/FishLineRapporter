...
library(Hmisc)
     mylatex(singleFish2,
             ...
             collabel.just=c(rep("l",3),rep("p{2cm}",5)),
             col.just=c(rep("l",3),rep("p{2cm}",5)),
...
} else if (unique(data4$dfuArea) %in% c(22,23,24)) {
...
} else if (unique(data4$dfuArea)>24 & unique(data4$dfuArea)<=32) {
