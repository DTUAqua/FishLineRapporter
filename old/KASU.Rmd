...
pos$station <- as.character(pos$station) # added by LDIE 03/06-2021
...
\subsection*{Stations}
`r nrow(pos)` hauls were conducted during the survey. The positions off all hauls are presented in the map in Fig. 1 and hauls per ICES area are plotted in the maps in Fig. 2-`r length(unique(pos$dfuArea))`.
...
dk_eez <- read.shapefile('eez_dk_LandAndSea_2017')

write.shapefile(coast, paste0("genetics_fish_", format(Sys.Date(), "%d%m%y")))
...
# changed by LDIE - 03/06-2021
par(cex = 0.2)
pointLabel(x=pos[pos$gearQuality=="V","lon"], y=pos[pos$gearQuality=="V","lat"],
     labels=pos[pos$gearQuality=="V","station"],cex=4,offset=-1,allowSmallOverlap = FALSE)
...
points(pos[pos$gearType=="OTB" & pos$gearQuality=="V","lon"], pos[pos$gearType=="OTB" & pos$gearQuality=="V","lat"], pch=16, col="blue", cex=.8)
points(pos[pos$gearType=="TV3" & pos$gearQuality=="V","lon"], pos[pos$gearType=="TV3" & pos$gearQuality=="V","lat"], pch=16, col="darkgreen", cex=.8)
points(pos[pos$gearQuality=="I","lon"], pos[pos$gearQuality=="I","lat"], pch=16, col="dark orange", cex=.8)


legend( x="bottomright", title = "Stations",
        legend=c("Valid TV3", "Valid OTB","Invalid haul"),
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=7, fig.height=8,fig.pos='h',fig.cap=paste0("Survey map with sampling stations in area 20, ",ship," Denmark, ",cruise_title,".\\label{fig:map20}")}


if (any(pos$dfuArea=="20")) {
...
points(pos[pos$gearType=="OTB" & pos$gearQuality=="V" & pos$dfuArea==20,"lon"], pos[pos$gearType=="OTB" & pos$gearQuality=="V"  & pos$dfuArea==20,"lat"], pch=16, col="blue", cex=.9)

points(pos[pos$gearType=="TV3" & pos$gearQuality=="V" & pos$dfuArea==20,"lon"], pos[pos$gearType=="TV3" & pos$gearQuality=="V"  & pos$dfuArea==20,"lat"], pch=16, col="darkgreen", cex=.9)

legend( x="bottomright", title = "Stations",
        legend=c("TV3", "OTB"),
        pch=c(16, 16), col = c("blue","darkgreen"),
        cex = 0.9)
title("Valid stations in ICES area 20",line=2)
}
```

```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=7, fig.height=8,fig.cap=paste0("Survey map with sampling stations in area 21, ",ship," Denmark, ",cruise_title,".\\label{fig:map21}"),fig.pos='h'}
...
points(pos[pos$gearType=="OTB" & pos$gearQuality=="V" & pos$dfuArea==21,"lon"], pos[pos$gearType=="OTB" & pos$gearQuality=="V"  & pos$dfuArea==21,"lat"], pch=16, col="blue", cex=.9)

points(pos[pos$gearType=="TV3" & pos$gearQuality=="V" & pos$dfuArea==21,"lon"], pos[pos$gearType=="TV3" & pos$gearQuality=="V"  & pos$dfuArea==21,"lat"], pch=16, col="darkgreen", cex=.9)

legend( x="bottomright", title = "Stations",
        legend=c("TV3", "OTB"),
        pch=c(16, 16), col = c("blue","darkgreen"),
        cex = 0.9)
title("Valid stations in ICES area 21",line=2)



```

```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=7, fig.height=8,fig.cap=paste0("Survey map with sampling stations in area 22, ",ship," Denmark, ",cruise_title,".\\label{fig:map22}"),fig.pos='h'}
...
points(pos[pos$gearType=="OTB" & pos$gearQuality=="V" & pos$dfuArea==22,"lon"], pos[pos$gearType=="OTB" & pos$gearQuality=="V"  & pos$dfuArea==22,"lat"], pch=16, col="blue", cex=.9)

points(pos[pos$gearType=="TV3" & pos$gearQuality=="V" & pos$dfuArea==22,"lon"], pos[pos$gearType=="TV3" & pos$gearQuality=="V"  & pos$dfuArea==22,"lat"], pch=16, col="darkgreen", cex=.9)

legend( x="bottomright", title = "Stations",
        legend=c("TV3", "OTB"),
        pch=c(16, 16), col = c("blue","darkgreen"),
        cex = 0.9)
title("Valid stations in ICES area 22",line=2)

```


```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.width=7, fig.height=8,fig.cap=paste0("Survey map with sampling stations in area 23, ",ship," Denmark, ",cruise_title,".\\label{fig:map23}"),fig.pos='h'}

pos <- data_sample[,c("gearType","gearQuality","lat","lon","dfuArea")]
...
points(pos[pos$gearType=="OTB" & pos$gearQuality=="V" & pos$dfuArea==23,"lon"], pos[pos$gearType=="OTB" & pos$gearQuality=="V"  & pos$dfuArea==23,"lat"], pch=16, col="blue", cex=.9)

points(pos[pos$gearType=="TV3" & pos$gearQuality=="V" & pos$dfuArea==23,"lon"], pos[pos$gearType=="TV3" & pos$gearQuality=="V"  & pos$dfuArea==23,"lat"], pch=16, col="darkgreen", cex=.9)

legend( x="bottomright", title = "Stations",
        legend=c("TV3", "OTB"),
        pch=c(16, 16), col = c("blue","darkgreen"),
        cex = 0.9)
title("Valid stations in ICES area 23",line=2)
